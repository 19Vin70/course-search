...
const Login = () => {
  ...
  return (
    ...
    <header className="mx-8 pt-20">
      <h1 className="text-gray-700 text-3xl font-bold">Sign In | <b className="text-emerald-400">Course</b>search</h1>
    </header>
    <div className="h-screen w-full bg-white flex flex-col md:flex-row md:justify-between">
      ...
      <div className="pt-16 md:pt-24 flex flex-col w-full md:w-[50%]">
        ...
        <div className="flex flex-col mx-8 mt-5">
          <button onClick={handleSignIn} className="w-full border-none rounded-lg bg-emerald-400 py-2.5 text-white font-medium flex justify-center">{
            loading ? (
        ...
        <h1 className="text-center mt-6 text-gray-600">Don't have an account? <Link className="text-emerald-400 hover:underline" to="/signup">Sign up</Link></h1>
        
        <h1 className="text-center my-4">OR</h1>
        
        <div className="flex flex-col mx-8 mt-">
          <button onClick={handleSignInWithGoogle} className="flex flex-row justify-center items-center w-full border-none rounded-lg bg-white py-2.5 text-gray-700 font-medium shadow hover:opacity-80">
